            ...
            <div className='relative md:w-[50%] w-full flex flex-col md:p-5 mt-4 mb-7 sm:justify-center sm:items-center sm:text-center'>
                ...
                <div className='flex flex-col sm:flex-row items-center gap-2 mt-6'>
                    ...
                    <Button
                        ...
                        customStyles={isFavorite ? 'bg-red-700 hover:bg-red-800 border-none text-white hover:text-white' : 'bg-green-700 hover:bg-green-800 border-none text-white hover:text-white'}
                    />
                </div>
            </div>
            {/* Recipe picture */}
