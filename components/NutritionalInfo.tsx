            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center">
                    <div className="bg-green-100 dark:bg-green-900 p-2 rounded-full">
                        <Apple strokeWidth={1} className="text-green-600 dark:text-green-300 w-8 h-8" />
                    </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center">
                    <div className="bg-blue-100 dark:bg-blue-900 p-2 rounded-full">
                        <Drumstick strokeWidth={1} className="text-blue-600 dark:text-blue-300 w-8 h-8" />
                    </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center">
                    <div className="bg-yellow-100 dark:bg-yellow-900 p-2 rounded-full">
                        <Wheat strokeWidth={1} className="text-yellow-600 dark:text-yellow-300 w-8 h-8" />
                    </div>
                    <h3 className="text-md text-gray-800 dark:text-gray-200 mt-3">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center">
                    <div className="bg-red-100 dark:bg-red-900 p-2 rounded-full">
                        <Droplet strokeWidth={1} className="text-red-600 dark:text-red-300 w-8 h-8" />
                    </div>
                    <h3 className="text-md text-gray-800 dark:text-gray-200 mt-3">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md flex flex-col items-center">
                    <div className="bg-pink-100 dark:bg-pink-900 p-2 rounded-full">
                        <Candy strokeWidth={1} className="text-pink-600 dark:text-pink-300 w-8 h-8" />
                    </div>
                    <h3 className="text-md text-gray-800 dark:text-gray-200 mt-3">
